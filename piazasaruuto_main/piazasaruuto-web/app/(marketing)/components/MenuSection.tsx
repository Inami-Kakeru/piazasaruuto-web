      ...
      <div className="mx-auto max-w-[88rem] px-4 md:px-6 py-16 md:py-20">
        ...
        <div className="mt-10 grid gap-6 md:gap-8 md:grid-cols-2">
          ...
          <article className="rounded-2xl border bg-white shadow-sm p-5 md:p-6">
            ...
            <div className="mt-4 flex flex-col gap-3">
              <span className="mk-btn mk-btn-disabled h-12 text-base" role="status" aria-live="polite">Web予約（Coming Soon）</span>
        ...
        <section aria-labelledby="course-title" className="mt-12 md:mt-16">
          ...
          <div className="mt-6 text-center">
            <span className="mk-btn mk-btn-disabled inline-flex h-12 text-base" role="status" aria-live="polite">増毛エクステ Web予約（Coming Soon）</span>
          </div>
        </section>
      </div>
    </section>
